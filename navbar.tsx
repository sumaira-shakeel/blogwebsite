...
//         }
//         setCurrentDateTime(now.toDateString("en.US", options) + '' + now.toLocaleTimeString("en.US", { hour12: false })
//         );
//       };
...
// </nav>
// <button className="inline-flex items-center bg-blue-700 border-0 py-1 px-3 focus:outline-none hover:bg-red-700 rounded text-white mt-4 md:mt-0 transition duration-300 ">
//   Git hub
//   <svg fill="none"
//   stroke="currentColor"
//   strokeLinecap="round"
